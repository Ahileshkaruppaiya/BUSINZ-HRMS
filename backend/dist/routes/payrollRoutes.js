...
payrollRouter.put('/settings', requirePermission('payroll', 'edit'), (req, res, next) => payrollController.updateSettings(req, res, next));
...
// Payroll Runs
payrollRouter.post('/runs', requirePermission('payroll', 'create'), (req, res, next) => payrollController.createRun(req, res, next));
