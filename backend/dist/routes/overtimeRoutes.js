...
overtimeRouter.use('/overtime', authenticateToken);
...
overtimeRouter.put('/overtime/:id/approve', requireRoles(['Super Admin', 'CEO', 'HR Manager', 'Department Manager', 'Finance Manager']), (req, res, next) => overtimeController.approveOvertime(req, res, next));
//# sourceMappingURL=overtimeRoutes.js.map